...
<body>
    <div class="container">
        ...
        <p>Enter verification code that has been already sent to your email, 
            <br>It might take some time, Please wait a minute and refresh your email...
        </p>
        ...
        <div class="status">
                ...
                <?php if($status == true){ ?>
                    <p class="success">
                        You've subscribed to <strong> The Great Comics successfuly... </strong> <br>
                        Check your email every 5 minutes to enjoy different Comics!!! <br>
